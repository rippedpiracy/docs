...
**_Requires Sign-up_**.  
<sub>Most Games that are uploaded to this site are uncracked and require a [Steam Emulator](#cracking-tools) to function (especially when its mentioned that the upload is "Clean (Steam) Files" or when it's uploaded to the SCS (Steam Content Sharing) forum).</sub>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sub>[KG-GUI](https://cs.rin.ru/forum/viewtopic.php?t=112374) - A simple GUI to configure Koalageddon</sub>
