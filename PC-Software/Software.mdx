...
_<small>Use the RuTracker.ru link if you dont't want to make an account for the other services.</small>_
...
_<small>*Staff Members from Ripped have Accounts on the site, so just ask in the Discord for something.*</small>_
