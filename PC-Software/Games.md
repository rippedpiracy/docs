...
**[GNARLY](https://rentry.org/gnarly_repacks) (DDL)**
...
[**EA DLC Unlocker v2**](https://anadius.su/dlc-unlockers) [<small>[cs.rin.ru]</small>](https://cs.rin.ru/forum/viewtopic.php?t=104412) - Tool that can unlock all DLCs on legitimately owned Origin/EA Games.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Origin DLC Unlocker v1](https://anadius.su/dlc-unlockers#:~:text=unlocks%205%20DLCs-,Origin%20DLC%20Unlocker,-v1) [<small>[cs.rin.ru]</small>](https://cs.rin.ru/forum/viewtopic.php?p=2085788#p2085788) - An older but still maintained version that has support for <span style="color:red">**Mac**</span> users.  
...
**If you're having issues with Goldberg, try this version [GBE Fork](https://github.com/Detanup01/gbe_fork).**  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[SKSAppManifestGenerator](https://github.com/Sak32009/SKSAppManifestGenerator) [<small>[cs.rin.ru]</small>](https://cs.rin.ru/forum/viewtopic.php?t=124087) - A CLI tool to generate .acf files for GreenLuma with ease.
 
[**Origin Unwrapper**](https://cs.rin.ru/forum/viewtopic.php?t=125589) - Unwraps the Game executable of Origin/EA Games from its Origin DRM. You will also likely need to use Origin Emulator. This project is abandoned.   
[**Origin Emulator**](https://cs.rin.ru/forum/viewtopic.php?t=115335) - Emulates the basic Origin/EA API. Using this tool you **can play Denuvo Protected Origin/EA Games but you have to obtain a Denuvo token**. This tool also includes a script to generate Denuvo tokens (you're generally limited to 5 a day with each token being tied to a single PC) **only if you own the Game legitimately**. The Denuvo bypass method works for Origin/EA Games on Steam too. This project is abandoned.   
