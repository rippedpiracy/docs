...
> A database with all release titles. These release titles are not for download, they are just records.<br />
> Apart from the release title, a record often also contains the release size, release date, and sometimes also NFOs.<br />
