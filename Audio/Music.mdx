...
_<small>You can also stream locally, more info at [https://wotaku.wiki/guides/music/squidify](https://wotaku.wiki/guides/music/squidify)</small>_
...
_**All plugins listed below require a paid account in their respective platforms except Musixmatch.**_  
...
_<small>This tool does not download songs directly from Spotify.</small>_
...
_<small>Actively maintained fork of the popular YouTube Downloader [youtube-dl](https://ytdl-org.github.io/youtube-dl/) with more functionality.</small>_
...
_<small>TuneMyMusic by itself has some free-tier limits, using it to transfer your libary to Deezer via [this partnership](https://www.deezer.com/explore/en-us/features/transfer-playlist/) doesn't.</small>_
