...
<sub>*Pro Tip: Make a Restore Point when modifying your Windows install!*</sub>

**[AtlasOS](https://atlasos.net)** - A lightweight modification of Windows designed to maximize your system's performance, privacy and optimize latency, Highly recommended.  
...
**[OptimizerNXT](https://github.com/hellzerg/optimizerNXT)** - A powerful, YAML-driven CLI tool for automating Windows tweaks.
...
<sub>
  *Disable
  ...
  to free as much space as your amount of RAM.*
</sub>
...
<Alert type="info">
  You can also grab an ISO from MASSGRAVE [**here**](https://massgrave.dev/genuine-installation-media) if you wish to reinstall Windows before running these apps.
</Alert>
