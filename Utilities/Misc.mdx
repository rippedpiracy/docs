...
<sub>
  We recommend coupling these Extensions & UserScripts with [**LibreWolf**](https://librewolf.net) or [**Ungoogled
  Chromium**](https://github.com/Eloston/ungoogled-chromium).
</sub>

[**uBlock Origin (<span className="text-red-500">Firefox</span>)**](https://github.com/gorhill/uBlock) | [**Lite (<span className="text-red-500">Chromium</span>)**](https://github.com/uBlockOrigin/uBOL-home) - An efficient Ad & Content Blocker for Chromium and Firefox, fast and lean.  
_<small>uBO **Lite** does **not** support Custom Filter Lists.</small>_
...
[**UserAgent-Switcher**](https://add0n.com/useragent-switcher.html) | [**Chameleon (<span className="text-red-500">Firefox</span>)**](https://sereneblue.github.io/chameleon/) - Highly configurable User-Agent Switchers.

[**Temporary Containers (<span className="text-red-500">Firefox</span>)**](https://github.com/stoically/temporary-containers) - Allows you to open tabs, websites, and links in automatically managed disposable containers. Containers isolate data websites store (cookies, storage, and more) from each other.  
...
[**NanaZip**](https://github.com/M2Team/NanaZip) | [**7-Zip**](https://7-zip.org/) | [**WinRAR**](https://www.win-rar.com/) - File archivers, can pack and unpack many archive types such as 7z, rar, zip, etc. NanaZip is a fork of 7-Zip with added functionality and better support for Windows 11.
...
[**YT-DLP**](https://github.com/yt-dlp/yt-dlp) - Can download from over 1500 sites including: Crunchyroll, Funimation, SoundCloud, Bandcamp, PornHub and more. [Here's all the supported sites](https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md).  
...
[**Stacher**](https://stacher.io/) - A modern YouTube Downloader, front-end/GUI for [yt-dlp](https://github.com/yt-dlp/yt-dlp).
...
[**CompactGUI**](https://github.com/ImminentFate/CompactGUI) | [**Compactor**](https://github.com/Freaky/Compactor) - Transparently compresses games, programs and other folders with almost no performance loss.

[**Text-Grab (<span className="text-red-500">Windows</span>)**](https://github.com/TheJoeFin/Text-Grab) | [**Frog (<span className="text-red-500">Linux</span>)**](https://getfrog.app/) - Use OCR to grab and read text from images or unselectable text.
...
[**WebTor**](https://webtor.io/) - Torrent and stream files in your browser, without needing to worry about ISPs and DMCAs (Limited download speed, do not log in or use for bigger files)

## Informational

[**Spyware Watchdog**](https://spyware.neocities.org/articles/) - Now inactive site which helps you remember that the programs and services you trust are not what they seem.
...
**_Use at your own risk due to many risky, unvetted sites._**
