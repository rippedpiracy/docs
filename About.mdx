...
This website is built using **Vite** and **React** with custom MDX rendering setup. You can write regular Markdown along with custom React components directly in `.mdx` files.
...
```html
Here is <u>underlined text</u> Here is <small>small text</small> Here is
