...
_<small>Use Japanese titles to get better results.</small>_
...
_<small>Check the [AnimePiracy Wiki](https://thewiki.moe/sourcing/ddl/#irc) for a detailed guide into XDCC.</small>_
...
**[Taiga (<span className="text-red-500">Windows</span>)](https://github.com/erengy/taiga)** | **[Trackma (<span className="text-red-500">Linux</span>)](https://github.com/z411/trackma/)** - Automatically detects the Anime Videos you watch on your PC and synchronizes your progress with AniList, Kitsu, MyAnimeList and more.  
...
[**SauceNAO**](https://saucenao.com) | [**Anime Scene Search Engine**](https://trace.moe/) - Reverse image search engines for Anime, SauceNAO is also helpful in identifying _sauce_.
