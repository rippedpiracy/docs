...
<details>
	...
	<p>
		<h4><span className="text-orange-500">Step 0: VPN</span></h4>
		...
		<h4><span className="text-orange-500">Step 1: Clear your cookies:</span></h4>
		...
		<h4><span className="text-orange-500">Step 2: Create a new E-Hentai account</span></h4>
		...
		<h4><span className="text-orange-500">Step 3: Wait 7-10 days</span></h4>
		<blockquote>Waiting sucks, but be patient, after this you'll have access to sadpanda for life.</blockquote>
		<h4><span className="text-orange-500">Step 4: Enjoy</span></h4>
		<blockquote>In case ExHentai still shows a blank page, repeat <span className="text-orange-500">Step 1</span>.</blockquote>
	</p>
</details>
