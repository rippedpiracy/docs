...
<h3>Manga</h3>
- [**E-Hentai**](http://e-hentai.org/) - The source of most of the manga online with an exceptional library, most of the translators also upload here. You can create bounties, fill requests and gain rep in its own system <small>(read more about it [here](https://ehwiki.org/wiki/Main_Page))</small>. In addition to h-manga, you can also find cosplays, image sets, game CGs and more.   
